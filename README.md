...
This project was written and compiled in C-Sharp. It will initially welcome the user to a splash page and prompt them to log in. Upon logging in, the user will be able view, add to, edit, and remove both various baked-goods and flavor descriptors. Each baked-good contains a name, a brief description and an associated set of flavors. Flavors and baked-goods can be associated in a series of many to many relationships.
...
## License
*Quin Asselin, January 2023. Available for distribution, modification, inspection, and application under [GPLv3 License](https://www.gnu.org/licenses/gpl-3.0.en.html)*
